...
public class ClickCollectMajorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pc_click_collect_major_activity);
        initUI();
    }
    ...
    private void initUI(){
        ...
        webView = (WebView) findViewById(R.id.click_major_detail_webview);
        ...
        collectImageView=(ImageView)findViewById(R.id.click_collect_major_imageView);
        collectImageView.setOnClickListener(this);
        shareImageView=(ImageView)findViewById(R.id.click_share_major_imageView);
        ...
        NetworkConnect.postData("home/getMajorId", postJSONString,
                new Callback<Object>() {
                    ...
                    public void onResponse(Call<Object> call, Response<Object> response) {
                        majorId=response.body().toString();
                    ...
                    public void onFailure(Call<Object> call, Throwable t) {
                        Toast.makeText(ClickCollectMajorActivity.this,"连接网络失败！请重试",Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.click_collect_major_imageView://点击关注
                ...
                if(isCollect==false){//进行关注操作
                    NetworkConnect.getData(BasicData.SERVER_ADDRESS, "home/majorCollect?userId="+userId+"&majorId="+majorId, new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            ...
                            updateCollect();
                            Toast.makeText(ClickCollectMajorActivity.this,"关注成功！",Toast.LENGTH_SHORT).show();
                        }
                    ...
                    NetworkConnect.getData(BasicData.SERVER_ADDRESS, "home/majorCancelCollect?userId="+userId+"&majorId="+majorId, new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            ...
                            updateCollect();
                            Toast.makeText(ClickCollectMajorActivity.this,"已取消关注！",Toast.LENGTH_SHORT).show();
                        }
            ...
            case R.id.share_major_imageView://点击分享
                //获取当前Activity截图
                final Bitmap bitmap=captureScreen(ClickCollectMajorActivity.this);
                //定义弹出适配器
                ArrayAdapter<String> shareAdapter=new ArrayAdapter<String>(ClickCollectMajorActivity.this,android.R.layout.simple_list_item_1,BasicData.SHARE_ITEM);
                //利用DialogPlus弹出对话框
                DialogPlus dialog = DialogPlus.newDialog(ClickCollectMajorActivity.this)
                        ...
                        .setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(DialogPlus dialog, Object item, View view, int position) {
                                ...
                                AndroidShare androidShare=new AndroidShare(ClickCollectMajorActivity.this);
                                if(result.equals("QQ")){
                                    androidShare.sharedQQ(ClickCollectMajorActivity.this,bitmap);
                                }
                                if(result.equals("微信")){
